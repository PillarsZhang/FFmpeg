...
#define DEFAULT_DESIRED_VIDEO_BUFFERS 256
...
static const AVOption options[] = {
    ...
    { "buffers",      "set number of capture buffers to request",                 OFFSET(desired_video_buffers), AV_OPT_TYPE_INT,    {.i64 = DEFAULT_DESIRED_VIDEO_BUFFERS }, 2, INT_MAX, DEC },
